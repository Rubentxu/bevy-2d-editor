...
#[deprecated(
    since = "0.87.0",
    note = "Use editor_model::ids::SceneAssetLocalId instead"
)]
...
pub use editor_model::scene_asset::SceneInstanceLayerKind;
...
pub use editor_model::scene_asset::SceneInstanceLayer;

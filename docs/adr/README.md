...
| [ADR-0055](./0055-semantic-graph-reactive-ecs.md)                               | Semantic Graphs Compile to Reactive Bevy ECS Runtime Projections                  | Accepted (2026-08-19) — M1 project graph foundation                   |
...
| [ADR-0057](./0057-compiled-incremental-logic-runtime.md)                      | Logic Graphs Use a Compiled Incremental Runtime                                  | Accepted (2026-08-19) — M2 logic runtime                              |

...
*Last updated: v0.75.0 — 2026-07-19 (Hito 4 Order 7 scene-component-authoring COMPLETE (3 PRs: #86 v0.73.0 + #87 v0.74.0 + #88 v0.75.0): backend foundation (SchemaKind enum + 3 #[serde(default)] ComponentSchema fields + FieldType ComponentRef/Enum + BsnIrNode.kind + 3 Command variants + 3 WASM exports) + frontend authoring UX (types/schema.ts + services/scene-components.ts + useSceneComponents hook + SchemaAuthoringPanel Kind toggle + Bind picker + auto_spawn + AddComponentButton 🧩 badge) + AI surface (3 new AI commands + FORBIDDEN_AI_COMMANDS extended with DeleteSceneComponent + RenameSceneComponent + propose_commands_schema extracted to JSON file to bypass macro recursion limit + 3 mock-ai-proxy patterns) + ADR-0016 + CONTEXT.md updated; 476 Rust tests passing (was 469 from Hito 4 Order 6; 5x5 stress stable); 26 review-aware tasks done (12 + 8 + 6); Hito 4 Order 6 complete from v0.72.0; next: Hito 4 Order 8 animation-graph-editor (deferred) or final cleanup)

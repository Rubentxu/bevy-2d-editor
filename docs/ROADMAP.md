...
| `v1.0-stabilization`                                | (cycle entry)                                    | **IN PROGRESS** (P1: canonical playable sample game, ✅ closed via BJ-1→BJ-5) — baseline evidence map committed 2026-09-06, refreshed 2026-09-08 (v0.109.9). Coverage score: **6 ✅ / 1 🟡 / 2 🔴** (G1, G2, G3, G7, G8, G9 green; G4 amber; G5, G6 red). See [`docs/v1.0-stabilization-evidence-map.md`](v1.0-stabilization-evidence-map.md). |

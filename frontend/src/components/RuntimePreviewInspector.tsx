...
export default function RuntimePreviewInspector() {
  ...
  return (
    <div className="runtime-preview-inspector" data-testid="runtime-preview-inspector">
      <header className="rpi-header">
        <h3>Runtime Preview</h3>
        {error && (
          <span
            className="rpi-error"
            data-testid="rpi-error"
            title={error}
          >
            error
          </span>
      ...
      {metrics && (
        <dl
          className="rpi-metrics"
          data-testid="rpi-metrics"
        >
          ...
          <div className="rpi-metric">
            <dt>Frame</dt>
            <dd data-testid="rpi-frame-time">{metrics.frame_time_ms.toFixed(2)} ms</dd>
          </div>
          <div className="rpi-metric">
            <dt>Rebuilds</dt>
          ...
          {mapping.map((m) => (
            ...
            >
              ...
              >
                ...
                <span className="rpi-row-count">
                  {m.component_count} comp
                </span>
              </button>
            </li>
          ))}
